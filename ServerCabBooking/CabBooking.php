...
<div id="content">
	<div id="colOne">
	  <div id="ihome4">
      <div id="title">CUSTOMERS CAB BOOKING DETAILS</div>
      <div id="work1">
        ...
        <th width="136">GET ADDRESS</th> 
       </tr>
        <?php	 
		error_reporting(error_reporting() & ~E_NOTICE);
 		include('dbcon.php');		
		
		$result=mysql_query("select * from cabbooking");
		while($rec = mysql_fetch_assoc($result))
		{
			 ...
			 echo $rec['status'];
			 print"</td><td>";
			 echo "<a href='https://www.gps-coordinates.net/'>View</a>";					 
			 print"</td>";
	 		 print"</tr>";  
		}   		
	  ?>  
	...
	<ul>		
        ...
        <li><a href="CabBooking.php" class="active">Cab Booking</a></li>        
