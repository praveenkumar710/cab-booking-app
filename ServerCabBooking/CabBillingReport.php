...
<div id="content">
	<div id="colOne">
	  <div id="ihome4">
      <div id="title">CAB BILLING REPORT</div>
       <div id="sreport">
  ...
  <tr>
    ...
    <td width="166"><input type="submit" name="Add" id="btn1" value="View Report"></td>
      ...
      <div id="work1">
       <table width="648" height="32" border="0">
        ...
        <th width="129">TOTAL KM</th>
        <th width="129">TOTAL WAITING TIME</th>
        <th width="129">TOTAL AMOUNT</th>
    ...
    <h2>Menu</h2>				
	<ul>		
		<li><a href="ServiceReport.php">Cab Booking Report</a></li>
        <li><a href="CabBillingReport.php" class="active">Cab Billing Report</a></li>
