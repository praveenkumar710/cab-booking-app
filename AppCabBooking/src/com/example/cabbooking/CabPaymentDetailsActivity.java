...
public class CabPaymentDetailsActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_cab_payment_details);
		
		StrictMode.setThreadPolicy(policy);			
		
		ActionBar ab=getActionBar();
        ab.setBackgroundDrawable(new ColorDrawable(Color.parseColor("#efef26")));
        getActionBar().setTitle(Html.fromHtml("<font color='#000000'>Cab Payment Details</font>"));
        
        ipaddress=getString(R.string.ipconfig);
    	url="http://"+ipaddress+"/ACabBooking/androidCabViewPayment.php";  
	...
	{		
		...
		{
			super.onPreExecute();
			pDialog = new ProgressDialog(CabPaymentDetailsActivity.this);
					...
					{	
						...
						{													
							...
							{									
								...
								tv1=new TextView(CabPaymentDetailsActivity.this);
								tv1.setId(1);
								...
								tv2=new TextView(CabPaymentDetailsActivity.this);
								tv2.setId(2);
								...
								tv3=new TextView(CabPaymentDetailsActivity.this);
								tv3.setId(3);
								...
								tv4=new TextView(CabPaymentDetailsActivity.this);
								tv4.setId(4);
								...
								tv5=new TextView(CabPaymentDetailsActivity.this);
								tv5.setId(5);
								...
								tv6=new TextView(CabPaymentDetailsActivity.this);
								tv6.setId(6);
								...
								tv7=new TextView(CabPaymentDetailsActivity.this);
								tv7.setId(7);
								...
								tv8=new TextView(CabPaymentDetailsActivity.this);
								tv8.setId(8);
								...
								tv9=new TextView(CabPaymentDetailsActivity.this);
								tv9.setId(9);
								...
								tv10=new TextView(CabPaymentDetailsActivity.this);
								tv10.setId(10);
								...
								tv11=new TextView(CabPaymentDetailsActivity.this);
								tv11.setId(11);
								...
								tv12=new TextView(CabPaymentDetailsActivity.this);
								tv12.setId(12);
								...
								tv13=new TextView(CabPaymentDetailsActivity.this);
								tv13.setId(13);
								...
								tv14=new TextView(CabPaymentDetailsActivity.this);
								tv14.setId(14);
								...
								tv15=new TextView(CabPaymentDetailsActivity.this);
								tv15.setId(15);
								...
								tv16=new TextView(CabPaymentDetailsActivity.this);
								tv16.setId(16);
								...
								tv17=new TextView(CabPaymentDetailsActivity.this);
								tv17.setId(17);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.cab_payment_details, menu);
		return true;
	}
