...
public class CabClosingActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_cab_closing);
    	...
    	url="http://"+ipaddress+"/ACabBooking/androidCabClosing.php";  
	...
	class cabClosing extends AsyncTask<String, String, String>
	{		
		@Override
		protected void onPreExecute() 
		{
			super.onPreExecute();
			pDialog = new ProgressDialog(CabClosingActivity.this);
					...
					{	
						...
						{													
							...
							{									
								...
								tv1=new TextView(CabClosingActivity.this);
								tv1.setId(1);
								...
								tv2=new TextView(CabClosingActivity.this);
								tv2.setId(2);
								...
								tv3=new TextView(CabClosingActivity.this);
								tv3.setId(3);
								...
								tv4=new TextView(CabClosingActivity.this);
								tv4.setId(4);
								...
								tv5=new TextView(CabClosingActivity.this);
								tv5.setId(5);
								...
								tv6=new TextView(CabClosingActivity.this);
								tv6.setId(6);
								...
								tv7=new TextView(CabClosingActivity.this);
								tv7.setId(7);
								...
								b=new Button(CabClosingActivity.this);
								b.setId(8);								
								...
								b.setOnClickListener(new View.OnClickListener() {									
									...
									public void onClick(View v) {
										...
										Intent i=new Intent(getApplicationContext(),CabClosing1Activity.class);
										i.putExtra("did",did);
										i.putExtra("dname",dname);							
										i.putExtra("cno",cno);
										i.putExtra("email",email);	
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.cab_closing, menu);
		return true;
	}
