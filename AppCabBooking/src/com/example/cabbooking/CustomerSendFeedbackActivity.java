...
public class CustomerSendFeedbackActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_customer_send_feedback);
    	...
    	url="http://"+ipaddress+"/ACabBooking/androidCustomerViewPayment1.php";  
	...
	{		
		...
		{
			super.onPreExecute();
			pDialog = new ProgressDialog(CustomerSendFeedbackActivity.this);
					...
					{	
						...
						{													
							...
							{									
								...
								tv1=new TextView(CustomerSendFeedbackActivity.this);
								tv1.setId(1);
								...
								tv2=new TextView(CustomerSendFeedbackActivity.this);
								tv2.setId(2);
								...
								tv3=new TextView(CustomerSendFeedbackActivity.this);
								tv3.setId(3);
								...
								tv4=new TextView(CustomerSendFeedbackActivity.this);
								tv4.setId(4);
								...
								tv5=new TextView(CustomerSendFeedbackActivity.this);
								tv5.setId(5);
								...
								tv6=new TextView(CustomerSendFeedbackActivity.this);
								tv6.setId(6);
								...
								tv7=new TextView(CustomerSendFeedbackActivity.this);
								tv7.setId(7);
								...
								tv8=new TextView(CustomerSendFeedbackActivity.this);
								tv8.setId(8);
								...
								tv9=new TextView(CustomerSendFeedbackActivity.this);
								tv9.setId(9);
								...
								b=new Button(CustomerSendFeedbackActivity.this);
								b.setId(10);								
								...
								b.setOnClickListener(new View.OnClickListener() {									
									@Override
									public void onClick(View v) {																			
										Intent i = new Intent(getApplicationContext(),CustomerSendFeedback1Activity.class);
										i.putExtra("bid",a1);	
										i.putExtra("dname",a2);	
										i.putExtra("dcno",a3);	
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.customer_send_feedback, menu);
		return true;
	}
