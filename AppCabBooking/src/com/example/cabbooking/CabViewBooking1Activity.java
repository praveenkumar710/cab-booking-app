...
public class CabViewBooking1Activity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_cab_view_booking1);
    	...
    	url="http://"+ipaddress+"/ACabBooking/androidCabPickupCustomer.php"; 
		...
		b2=(Button)findViewById(R.id.btn2);
		 b2.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				gps = new GPSTracker(CabViewBooking1Activity.this);    				
   		        if(gps.canGetLocation())
   		        {		        	
   		        	latitude = gps.getLatitude();
   		        	longitude = gps.getLongitude();    
   		        	
   		        	Geocoder geocoder = new Geocoder(CabViewBooking1Activity.this, Locale.getDefault());
				...
				cabPickupCustomer l=new cabPickupCustomer();
				l.execute(url); 
	...
	public class cabPickupCustomer extends AsyncTask<String, String, String>
	{
		@Override
		protected void onPreExecute() {
			// TODO Auto-generated method stub
			super.onPreExecute();
			pd=new ProgressDialog(CabViewBooking1Activity.this);
			...
			try 
			{
				...
				runOnUiThread( new Runnable() 
				{
					public void run() 
					{
						if(s==1)
						{							
							Toast.makeText(getApplicationContext(), "Customer Pickup Successfully", Toast.LENGTH_SHORT).show();
							Intent i=new Intent(getApplicationContext(),CabHomeActivity.class);
							i.putExtra("did",did);
							i.putExtra("dname",dname);							
							i.putExtra("cno",cno);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.cab_view_booking1, menu);
		return true;
	}
